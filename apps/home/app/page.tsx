...
import { Dispatch, HtmlHTMLAttributes, SetStateAction, SVGProps, useState } from 'react';

export type WelcomeViewProps = HtmlHTMLAttributes<HTMLDivElement>;
...
function Header({ setMobileMenuOpen, mobileMenuOpen }: HeaderProps) {
  return (
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-neutral-900/10">
...
export function WelcomeView() {
  ...
  return (
    <div className="wa-page bg-neutral-100">
      ...
      <main>
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div className="flex">
                <div className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-neutral-600 ring-1 ring-neutral-900/10 hover:ring-neutral-900/20">
                  <span className="text-primary-600 font-semibold">We’re hiring</span>
                  <span aria-hidden="true" className="h-4 w-px bg-neutral-900/10" />
          ...
          <div className="relative isolate overflow-hidden bg-neutral-900 px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
            ...
            >
              <div
                ...
                className="from-primary-400 to-secondary-600 aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr opacity-25"
              />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-primary-600 text-base font-semibold leading-7">Deploy faster</h2>
              ...
              {secondaryFeatures.map((feature) => (
                <div key={feature.name} className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-neutral-900">
                    <feature.icon
                      aria-hidden="true"
                      className="text-primary-600 h-5 w-5 flex-none"
                    />
                    {feature.name}
                  </dt>
                  <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-neutral-600">
                    ...
                    <p className="mt-6">
                      <a
                        href={feature.href}
                        className="text-primary-600 text-sm font-semibold leading-6"
                      >
                        Learn more <span aria-hidden="true">→</span>
                      </a>
                    </p>
          ...
          <div className="relative">
            ...
            >
              <div
                ...
                className="from-primary-400 to-secondary-400 ml-[max(50%,38rem)] aspect-[1313/771] w-[82.0625rem] bg-gradient-to-tr"
              />
            </div>
            <div
              aria-hidden="true"
            ...
            >
              <div
                ...
                className="from-primary-400 to-secondary-600 ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-gradient-to-tr xl:ml-0 xl:mr-[calc(50%-12rem)]"
              />
            </div>
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-xl sm:text-center">
                <h2 className="text-primary-600 text-lg font-semibold leading-8 tracking-tight">
                  Testimonials
                </h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl">
      ...
      {/* Footer */}
      <footer aria-labelledby="footer-heading" className="mt-32 bg-neutral-900 sm:mt-56">
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
            ...
            <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
              ...
              <input
                ...
                placeholder="Enter your email"
                autoComplete="email"
                className="focus:ring-primary-500 w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-1.5 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-neutral-500 focus:ring-2 focus:ring-inset sm:w-56 sm:text-sm sm:leading-6"
              />
